                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="image-upload-wrap">
                                            <input class="file-upload-input" type="file" id="image_link"
                                                   name="image_link"
...
@section('scripts')
    ...
    <script>
        ...
        function createProduct() {
            ...
            let inputImageLink = $('input[id="image_link"]')[0].files[0]
            ...
            if (typeof inputName === 'undefined' || inputName == '') {
                ...
                $("form>.form-group").find(".alert-padding").remove()
                errMess('content', "Bạn chưa nhập mô tả")
                return false
            } else if (typeof inputPrice === 'undefined' || inputPrice == '') {
                $("form>.form-group").find(".alert-padding").remove()
                errMess('price', "Bạn chưa nhập giá")
                return false
            } else if (typeof inputDiscount === 'undefined' || inputDiscount == '') {
                $("form>.form-group").find(".alert-padding").remove()
                errMess('discount', "Bạn chưa nhập discount")
                return false
                ...
                $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: "/admin/submit-create-once-product",
                    data: form_data,
                    headers: {
